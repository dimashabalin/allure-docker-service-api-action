...
upload_results() {
    ...
    echo "There is a service BUG. Temporarily use generic address for the project page and latest report"
    echo "${ALLURE_SERVER}/allure-ui/allure-docker-service-ui/projects/${PROJECT_ID}"
}
